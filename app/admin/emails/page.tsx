...
export default function AdminEmailsPage() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto" style={{ color: "#111827" }}>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold mb-1" style={{ color: "#111827" }}>Templates Email</h1>
      ...
      {/* Step guide */}
      <div className="rounded-xl p-5 border mb-6" style={{ background: "#fff7ed", borderColor: "rgba(201,110,44,0.2)", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
        <div className="flex items-center gap-2 mb-4">
          <span style={{ color: "#C96E2C" }}><Icon name="info" size={16} /></span>
          <h2 className="text-sm font-semibold" style={{ color: "#C96E2C" }}>Comment configurer les emails Supabase</h2>
        </div>
          ...
          {[
            ...
            <div key={item.step} className="flex items-start gap-3">
              <div
                ...
                style={{ background: "#C96E2C", color: "#fff" }}
              >
                {item.step}
              </div>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-lg text-sm font-medium transition-opacity hover:opacity-85"
          ...
          >
            ...
            <div className="flex items-center justify-between gap-4 px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-[14px]" style={{ color: "#111827" }}>{tpl.label}</div>
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <button
                  ...
                  style={{
                    background: copied === tpl.id ? "#dcfce7" : "#fff7ed",
                    color: copied === tpl.id ? "#16a34a" : "#C96E2C",
                    border: `1px solid ${copied === tpl.id ? "#bbf7d0" : "rgba(201,110,44,0.2)"}`,
                  }}
                >
            ...
            {/* Variables */}
            <div className="px-5 pb-3 flex items-center gap-2 flex-wrap" style={{ borderTop: "1px solid #f3f4f6" }}>
              <span className="text-[11px] pt-2" style={{ color: "#9ca3af" }}>Variables :</span>
              {tpl.variables.map((v) => (
                <span
                  key={v}
                  className="font-mono text-[10px] px-2 py-0.5 rounded mt-2"
              ...
              <span
                className="ml-auto text-[11px] px-2 py-0.5 rounded mt-2"
                style={{ background: "#f3f4f6", color: "#6b7280" }}
              >
                Clé Supabase : <span style={{ color: "#374151", fontWeight: 500 }}>{tpl.supabaseKey}</span>
              </span>
            </div>
            ...
            {selected === tpl.id && (
              <div className="border-t" style={{ borderColor: "#e5e7eb" }}>
                <div className="px-5 py-2 flex items-center gap-2 border-b" style={{ borderColor: "#f0f0f0", background: "#f9fafb" }}>
                  <span style={{ color: "#9ca3af" }}><Icon name="eye" size={13} /></span>
                  <span className="text-xs" style={{ color: "#6b7280" }}>Aperçu rendu</span>
                </div>
                {previewLoading ? (
      ...
      <div className="rounded-xl p-5 border" style={{ background: "#ffffff", borderColor: "#e5e7eb", boxShadow: "0 1px 3px rgba(0,0,0,0.06)" }}>
        <div className="flex items-center gap-2 mb-1">
          <span style={{ color: "#6b7280" }}><Icon name="mail" size={16} /></span>
          <h2 className="text-sm font-semibold" style={{ color: "#374151" }}>Tester l&apos;envoi d&apos;email</h2>
        </div>
