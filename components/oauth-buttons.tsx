      ...
      <div className="flex flex-col gap-2">
        {PROVIDERS.map((p) => (
          <button
            ...
            className="flex items-center justify-center gap-2.5 h-[44px] w-full rounded-lg border text-[13.5px] font-medium transition-colors hover:bg-surface-3 active:scale-[0.99]"
